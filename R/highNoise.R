...
#' }
#' @details \code{highNoise} provides a sample of simulated data that were developed to analyze variability and sensitivity of \code{FPM}. 
#' Simulated datasets (n=1000) were originally developed for the analyses; \code{highNoise} is a single realization of the simulation.
#' Simulations were generated using the covariance matrix of \code{h.northport} sediment chemical concentrations and the
#' \code{rmvnorm} function from the 'splus2R' package (Constantine and Hesterberg 2021). \code{Hit} values were generated with \code{toxCRM}
...
#' Random normal noise  was added to the \code{highNoise} datasets by inputting \code{eSD} values into \code{toxCRM} equal to 20% of the range of chemical concentrations (chemical-specific).
...
#' @seealso FPM, toxCRM, h.northport, perfect, lowNoise
#' @references
